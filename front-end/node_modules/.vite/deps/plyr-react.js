...
function useAptor(ref, configuration, deps = []) {
  ...
  const { instantiate: instantiate2, destroy: destroy3, getAPI: getAPI2, params } = configuration;
...
var instantiate = (_, params) => {
  const plyr = new plyr_default(".plyr-react", params.options || {});
  if (params.source)
